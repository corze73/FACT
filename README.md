...
Built with **React + Vite**, **Supabase**, and hosted on **Bolt** with a custom domain: [findacoachtoday.com](https://findacoachtoday.com).

---

## ✨ Features

- 🔑 **Authentication & Roles** – User, Coach, and Admin roles with Supabase Auth  
